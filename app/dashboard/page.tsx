        ...
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="flex items-center gap-5">
              <Link href="/dashboard" className="text-[13px] text-[#111827] font-medium">Dashboard</Link>
              <Link href="/projects" className="text-[13px] text-[#6b7280] hover:text-[#111827] transition-colors">Projects</Link>
            </nav>
          </div>
